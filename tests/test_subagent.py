...
from codeshell.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from codeshell.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from codeshell.agents.trace import TraceManager, TraceNode
from codeshell.agents.task_manager import BackgroundTask, TaskManager
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".codeshell" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from codeshell.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from codeshell.tools.agent_tool import AgentToolParams
