...
PROJECT_AGENTS_DIR = ".codeshell/agents"
USER_AGENTS_DIR = "~/.codeshell/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("codeshell.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from codeshell.agents.parser import parse_frontmatter, _validate_agent_meta
