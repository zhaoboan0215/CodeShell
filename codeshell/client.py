...
from codeshell.mcp.loading_strategy import NATIVE_TOOL_SEARCH_BETA
from codeshell.conversation_pairing import ensure_tool_pairing
from codeshell.serialization import (
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .codeshell/config.yaml or via ANTHROPIC_API_KEY env var."
            )
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .codeshell/config.yaml or via OPENAI_API_KEY env var."
            )
